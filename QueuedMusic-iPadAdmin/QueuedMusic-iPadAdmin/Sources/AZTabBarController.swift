...
public class AZTabBarController: UIViewController {
    ...
    /// - Returns: The instance of AZTabBarController which was created.
    open class func insert(into parent:UIViewController, view containerView: UIView, withTabIcons icons: [UIImage],andSelectedIcons sIcons: [UIImage]? = nil)->AZTabBarController {
  ...
  /*  open var tabBarHeight: CGFloat{
    ...
    open var tabBarWidth: CGFloat {
        get{
            return self.buttonsContainerWidthConstraintInitialConstant
        }set{
            self.buttonsContainerWidthConstraintInitialConstant = newValue
            self.buttonsContainerWidthConstraint.constant = newValue
        }
    }
    ...
    fileprivate var buttonsContainerWidthConstraint:NSLayoutConstraint!
    ...
    internal var buttonsContainerWidthConstraintInitialConstant:CGFloat!
    ...
    override public func loadView() {
        ...
        self.controllersContainer.backgroundColor = #colorLiteral(red: 0.1490196078, green: 0.2274509804, blue: 0.2784313725, alpha: 1)
        ...
        self.buttonsContainer.topAnchor.constraint(equalTo: margins.topAnchor, constant: 0).isActive = true
        self.buttonsContainerWidthConstraint = self.buttonsContainer.widthAnchor.constraint(equalToConstant: 80)
        self.buttonsContainerWidthConstraint.isActive = true
        /*
        ...
        self.controllersContainer.topAnchor.constraint(equalTo: margins.topAnchor, constant: 0).isActive = true
        self.controllersContainer.bottomAnchor.constraint(equalTo: margins.bottomAnchor).isActive = true
        self.controllersContainer.leadingAnchor.constraint(equalTo: margins.leadingAnchor, constant: 80).isActive = true
    ...
    override public func viewDidLoad() {
        ...
        self.buttonsContainerWidthConstraintInitialConstant = self.buttonsContainerWidthConstraint.constant
    }
    ...
    open func setIndex(_ index:Int,animated: Bool = false){
    ...
    open func setBar(hidden: Bool, animated: Bool,duration: TimeInterval = 0.3, completion: ((Bool)->Void)? = nil) {
        let animations = {() -> Void in
            self.buttonsContainerWidthConstraint.constant = hidden ? 0 : self.buttonsContainerWidthConstraintInitialConstant
            self.view.layoutIfNeeded()
        }
        if animated {
            self.view.layoutIfNeeded()
    ...
    private func setupButtons(){
        ...
        if self.buttons == nil {
            ...
            for i in 0 ..< self.tabIcons.count {
                ...
                if (i == self.tabIcons.count - 1) {
                    button.translatesAutoresizingMaskIntoConstraints = false
                    button.leftAnchor.constraint(equalTo: self.buttonsContainer.leftAnchor).isActive = true
                    button.bottomAnchor.constraint(equalTo: self.buttonsContainer.bottomAnchor).isActive = true
                    ...
                    button.translatesAutoresizingMaskIntoConstraints = false
                    button.leftAnchor.constraint(equalTo: self.buttonsContainer.leftAnchor).isActive = true
                    button.topAnchor.constraint(equalTo: self.buttonsContainer.topAnchor, constant: CGFloat(80 * i)).isActive = true
                    button.widthAnchor.constraint(equalToConstant: 80).isActive = true
                    button.heightAnchor.constraint(equalToConstant: 80).isActive = true
                }
        ...
        self.buttonsContainer.backgroundColor = #colorLiteral(red: 0.09803921569, green: 0.1607843137, blue: 0.2039215686, alpha: 1) // self.buttonsBackgroundColor != nil ? self.buttonsBackgroundColor : #colorLiteral(red: 0.09803921569, green: 0.1607843137, blue: 0.2039215686, alpha: 1)
    }
        ...
        if let controller = controllers[index], !(animated && isAnimating) {
            ...
            for i in 0 ..< self.tabIcons.count{
                ...
                if (button.isSelected) {
                    button.backgroundColor = #colorLiteral(red: 0.1490196078, green: 0.2274509804, blue: 0.2784313725, alpha: 1)
                } else {
                    button.backgroundColor = #colorLiteral(red: 0.09803921569, green: 0.1607843137, blue: 0.2039215686, alpha: 1)
                }
